...
if Rails.env.development?
  20.times do
    Developer.create!([
      { first_name: Name.first_name,
        ...
        ein: Company.ein,
        fb_image: nil,
        min_contract_amount: rand(500..10_000),
        agree_to_terms: true,
        balance: 0,
  ...
  Employer.create!([
    { first_name: 'Employer',
      ...
      ein: Company.ein,
      fb_image: nil,
      min_contract_amount: rand(500..50_000),
      agree_to_terms: true,
      balance: 0,
      cell: PhoneNumber.cell_phone,
      full_time_option: nil,
...

  {
    ...
    'Frontend' =>
      %w(HTML CSS Javascript jQuery AngularJS BackboneJS EmberJS),
    'Frontend Frameworks' =>
      %w(Foundation Bootstrap Meteor Phonegap),
    'Databases' =>
      %w(MySQL Postgres MongoDB SQL CouchDB),
    'Backend Frameworks' =>
      %w(Rails Laravel CakePHP Wordpress),
    'Other Coding SKills' =>
      %w(Git GitHub Coffeescript Sass LESS),
    'Design' =>
      %w(Photoshop Illustator)
