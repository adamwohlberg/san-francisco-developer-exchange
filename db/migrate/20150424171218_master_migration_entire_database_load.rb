class MasterMigrationEntireDatabaseLoad < ActiveRecord::Migration
  def change
    ...
    add_index 'contracts_skills', %w(contract_id skill_id), name: 'index_by_contract_and_skills', unique: true, using: :btree
    ...
    add_index 'developer_favorites', %w(developer_id contract_id), name: 'index_developer_favorites_on_developer_id_and_contract_id', unique: true, using: :btree
    ...
    add_index 'developers_skills', %w(developer_id skill_id), name: 'index_by_developer_and_skills', unique: true, using: :btree
    ...
    add_index 'employer_blocks', %w(employer_id developer_id), name: 'index_employer_blocks_on_employer_id_and_developer_id', unique: true, using: :btree
    ...
    add_index 'employer_favorites', %w(employer_id developer_id), name: 'index_employer_favorites_on_employer_id_and_developer_id', unique: true, using: :btree
    ...
    add_index 'negotiations', %w(developer_id employer_id), name: 'index_negotiations_on_developer_id_and_employer_id', using: :btree
