class TradingFloorController < ApplicationController
	...
	def index
		...
		@contract_php_junior = Contract.where(title: 'PHP Developer (Junior)').order(amount: :desc).first
		@contract_php_midlevel = Contract.where(title: 'PHP Developer (Mid-level)').order(amount: :desc).first
		@contract_php_senior = Contract.where(title: 'PHP Developer (Senior)').order(amount: :desc).first
		...
		@contract_ruby_junior = Contract.where(title: 'Ruby on Rails Developer (Junior)').order(amount: :desc).first
		@contract_ruby_midlevel = Contract.where(title: 'Ruby on Rails Developer (Mid-level)').order(amount: :desc).first
		@contract_ruby_senior = Contract.where(title: 'Ruby on Rails Developer (Senior)').order(amount: :desc).first
		...
		@contract_ios_junior = Contract.where(title: 'iOS Developer (Junior)').order(amount: :desc).first
		@contract_ios_midlevel = Contract.where(title: 'iOS Developer (Mid-level)').order(amount: :desc).first
		@contract_ios_senior = Contract.where(title: 'iOS Developer (Senior)').order(amount: :desc).first
		...
		@contract__android_junior = Contract.where(title: 'Android Developer (Junior)').order(amount: :desc).first
		@contract__android_midlevel = Contract.where(title: 'Android Developer (Mid-level)').order(amount: :desc).first
		@contract__android_senior = Contract.where(title: 'Android Developer (Senior)').order(amount: :desc).first
		...
		@contract_java_junior = Contract.where(title: 'Java Developer (Junior)').order(amount: :desc).first
		@contract_java_midlevel = Contract.where(title: 'Java Developer (Mid-level)').order(amount: :desc).first
		@contract_java_senior = Contract.where(title: 'Java Developer (Senior)').order(amount: :desc).first
		...
		@contract_frontend_junior = Contract.where(title: 'Front-End Developer (Junior)').order(amount: :desc).first
		@contract_frontend_midlevel = Contract.where(title: 'Front-End Developer (Mid-level)').order(amount: :desc).first
		@contract_frontend_senior = Contract.where(title: 'Front-End Developer (Senior)').order(amount: :desc).first
		...
		@contract_ui_ux_junior = Contract.where(title: 'UI/UX Developer (Junior)').order(amount: :desc).first
		@contract_ui_ux_midlevel = Contract.where(title: 'UI/UX Developer (Mid-level)').order(amount: :desc).first
		@contract_ui_ux_senior = Contract.where(title: 'UI/UX Developer (Senior)').order(amount: :desc).first
		...
		@contract_project_manager_junior = Contract.where(title: 'Project Manager (Junior)').order(amount: :desc).first
		@contract_project_manager_midlevel = Contract.where(title: 'Project Manager (Mid-level)').order(amount: :desc).first
		@contract_project_manager_senior = Contract.where(title: 'Project Manager (Senior)').order(amount: :desc).first
		...
		@contract_creative_director_junior = Contract.where(title: 'Creative Director (Junior)').order(amount: :desc).first
		@contract_creative_director_midlevel = Contract.where(title: 'Creative Director (Mid-level)').order(amount: :desc).first
		@contract_creative_director_senior = Contract.where(title: 'Creative Director (Senior)').order(amount: :desc).first
